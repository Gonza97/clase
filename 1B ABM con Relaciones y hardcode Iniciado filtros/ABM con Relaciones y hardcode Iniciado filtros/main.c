...
void inicializarClientesMedicamentos(eClienteMedicamento CliMed[], int sizeCliMedi)
{
    int idCliente[]= {111,222,333,444,555,666,777,888,999,101010};
    int idMedicamento[]= {104,100,101,101,101,102,103,101,101,100};
    int cantidad[]= {3,5,3,6,1,3,3,1,2,2};
}

void inicializarTopVentas(eTopVentas Top[], int )
{
    int idMedicamento[]= {104,100,101,101,101,102,103,101,101,100};
    int cantidad[]= {3,5,3,6,1,3,3,1,2,2};
}
